#!/bin/bash
#
# RCAN Super-Resolution - Deploy and Test Script
#
...
# Device paths
DEVICE_DIR="/data/local/tmp/rcan_test"
DEVICE_MODEL="${DEVICE_DIR}/rcan_model.dla"
DEVICE_INPUT="${DEVICE_DIR}/input.png"
DEVICE_OUTPUT="${DEVICE_DIR}/output.png"
DEVICE_EXEC="${DEVICE_DIR}/rcan_inference"

# Local paths
LOCAL_EXEC="${SCRIPT_DIR}/libs/arm64-v8a/rcan_inference"
LOCAL_MODEL="${PROJECT_ROOT}/models/RCAN_x4_256x256_MT8371.dla"
LOCAL_TEST_IMAGE="${PROJECT_ROOT}/../test_data/0853x4.png"

echo "========================================"
echo "RCAN Super-Resolution - Deploy & Test"
echo "========================================"
...
echo ""
echo "========================================"
echo "Running RCAN inference..."
echo "========================================"
adb shell "cd ${DEVICE_DIR} && LD_LIBRARY_PATH=${MTK_NEUROPILOT_SDK}/target/lib64 ./rcan_inference rcan_model.dla input.png output.png"

# Pull result
echo ""
echo "[INFO] Pulling output image..."
adb pull "${DEVICE_OUTPUT}" "${SCRIPT_DIR}/output_rcan.png"
...
echo "Test completed!"
echo "========================================"
echo "Output saved to: ${SCRIPT_DIR}/output_rcan.png"
ls -lh "${SCRIPT_DIR}/output_rcan.png"

echo ""
echo "To view the result, you can:"
echo "  1. Open ${SCRIPT_DIR}/output_rcan.png"
