#!/bin/bash
#
# RCAN Super-Resolution - Build Script
#
...
echo "========================================"
echo "RCAN Super-Resolution - Build Script"
echo "========================================"
...
echo "========================================"
echo "Executable: libs/arm64-v8a/rcan_inference"
echo ""
ls -lh libs/arm64-v8a/rcan_inference
echo ""

echo "Next step:"
echo "  ./deploy_with_sdk_lib.sh"
