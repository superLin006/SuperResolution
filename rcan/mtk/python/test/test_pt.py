...
from rcan_model import load_rcan_from_checkpoint, create_core_model_from_full
...
def test_torchscript_export():
    ...
    print("\n" + "="*70)
    print("Test 1: TorchScript Export (510x339)")
    print("="*70)
    
    checkpoint_path = "../../../../data/models/rcan/RCAN_BIX4.pt"
    output_path = "../models/RCAN_BIX4_core_339x510_test.pt"
    ...
    try:
        ...
        model = load_rcan_from_checkpoint(checkpoint_path, scale=4)
        model.eval()
...
def test_torchscript_inference():
    ...
    print("\n" + "="*70)
    print("Test 2: TorchScript Inference with Real Image (510x339)")
    print("="*70)
    ...
    try:
        ...
        if PIL_AVAILABLE and os.path.exists(image_path):
            output_path_img = os.path.join(output_dir, "rcan_torchscript_core_510x339.png")
...
def test_output_consistency():
    ...
    print("\n" + "="*70)
    print("Test 3: PyTorch vs TorchScript Consistency (510x339)")
    print("="*70)
    ...
    try:
        ...
        full_model = load_rcan_from_checkpoint(checkpoint_path, scale=4)
...
def main():
    """Run all tests"""
    print("\n" + "="*70)
    print("RCAN TorchScript Conversion Tests")
    print("="*70)
