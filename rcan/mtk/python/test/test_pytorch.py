"""
Test RCAN PyTorch model loading and inference
"""
...
from rcan_model import load_rcan_from_checkpoint, create_core_model_from_full, get_meanshift_params
...
def test_pytorch_load():
    """Test loading RCAN PyTorch checkpoint"""
    print("\n" + "="*70)
    print("Test 1: Load PyTorch RCAN Model")
    print("="*70)
...
def test_pytorch_inference():
    """Test RCAN inference on PyTorch"""
    print("\n" + "="*70)
    print("Test 2: PyTorch Inference with Real Image (510x339)")
    print("="*70)
    ...
    try:
        ...
        if PIL_AVAILABLE and os.path.exists(image_path):
            output_path = os.path.join(output_dir, "rcan_pytorch_510x339.png")
...
def main():
    """Run all tests"""
    print("\n" + "="*70)
    print("RCAN PyTorch Model Tests")
    print("="*70)
