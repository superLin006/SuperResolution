...
#ifndef _RKNN_DEMO_RCAN_H_
#define _RKNN_DEMO_RCAN_H_

#include "rknn_api.h"
#include "common.h"

// RCAN application context
typedef struct {
 ...
 * @return 0 on success, negative on failure
 */
int inference_rcan_model(rknn_rcan_context_t* app_ctx,
                         image_buffer_t* src_img,
                         image_buffer_t* dst_img);

#endif //_RKNN_DEMO_RCAN_H_
