"""Local testing script for RCAN model."""
...
def test_model(model_path, test_image_dir, output_dir, scale=2, channels=64, num_groups=10, num_blocks=20):
    """Test RCAN model on test images.
    ...
    Args:
        ...
        num_blocks: Number of residual blocks per group
    """
    # Create model
    model = RCAN(channels=channels, num_groups=num_groups, num_blocks=num_blocks, scale=scale)
    ...
    if model_path and os.path.exists(model_path):
        ...
        print(f"Warning: Model path {model_path} not found or not provided, using random weights")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Test RCAN model locally')
    ...
    parser.add_argument('--output_dir', type=str, default='../../results/rcan',
    ...
    parser.add_argument('--num_groups', type=int, default=10, help='Number of residual groups')
    parser.add_argument('--num_blocks', type=int, default=20, help='Number of residual blocks per group')
