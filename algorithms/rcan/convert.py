"""Model conversion script for RCAN using mlkits."""
...
def convert_model(model_path, config_path, output_dir, channels=64, num_groups=10, num_blocks=20, scale=2, platform='MT6989', neuron_sdk_path=None):
    """Convert RCAN model using mlkits.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Convert RCAN model using mlkits')
    parser.add_argument('--model_path', type=str, default='',
                       help='Path to model checkpoint (optional)')
    parser.add_argument('--config', type=str, default='config.yaml',
                       help='Path to mlkits config YAML file')
    parser.add_argument('--output_dir', type=str, default='../../results/rcan/converted',
