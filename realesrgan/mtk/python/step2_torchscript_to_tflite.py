...
def convert_to_tflite(
    ...
    if input_shape is None:
        # 文件名格式: RealESRNet_x4plus_core_339x510.pt
    ...
    # 构建输出路径
    # RealESRNet_x4plus_core_339x510.pt -> RealESRNet_x4plus_339x510.tflite
    basename = os.path.basename(torchscript_path)
    ...
    print(f"\n下一步:")
    print(f"  1. 测试TFLite: python test/test_tflite.py --tflite {tflite_path} --input ../../test_data/input_510x339.png")
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
  python step2_torchscript_to_tflite.py --torchscript ../../models/RealESRNet_x4plus_core_339x510.pt
  python step2_torchscript_to_tflite.py --torchscript ../../models/RealESRNet_x4plus_core_339x510.pt --input_shape 1 3 339 510
        """
    )
