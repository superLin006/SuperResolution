...
def compile_dla(
    ...
    # 构建输出路径
    # RealESRNet_x4plus_339x510.tflite -> RealESRNet_x4plus_339x510_MT8371.dla
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
示例:
  python step3_tflite_to_dla.py --tflite ../../models/RealESRNet_x4plus_339x510.tflite
  python step3_tflite_to_dla.py --tflite ../../models/RealESRNet_x4plus_339x510.tflite --platform MT6899
        """
    )
