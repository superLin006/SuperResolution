...
def test_tflite_load():
    ...
    print("\n" + "="*70)
    print("Test 1: Load TFLite Model")
    print("="*70)
    ...
    model_path = "../models/EDSR_x4_256x256_test.tflite"
...
def test_tflite_inference():
    ...
    print("\n" + "="*70)
    print("Test 2: TFLite Inference with Real Image (256x256)")
    print("="*70)
    ...
    try:
        ...
        if PIL_AVAILABLE and os.path.exists(image_path):
            ...
            if img_data:
                ...
                test_input = np.random.randn(1, 3, 256, 256).astype(np.float32) * 127.5 + 127.5
        else:
        ...
        if PIL_AVAILABLE and os.path.exists(image_path):
            output_path_img = os.path.join(output_dir, "edsr_tflite_core_256x256.png")
...
def test_tflite_conversion_chain():
    ...
    ts_path = "../models/EDSR_x4_core_256x256_test.pt"
    tflite_path = "../models/EDSR_x4_256x256_test.tflite"
...
def main():
    """Run all tests"""
    print("\n" + "="*70)
    print("EDSR TFLite Conversion Tests")
    print("="*70)
